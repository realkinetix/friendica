<script type="text/javascript" src="view/theme/frio2/js/mod_admin.js"></script>
<link rel="stylesheet" href="view/theme/frio2/css/mod_admin.css" type="text/css" media="screen"/>
