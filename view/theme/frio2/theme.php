...
/*
 * Name: frio2
 * Description: Bootstrap V4 theme. The theme is currently under construction, so it is far from finished. For further information have a look at the <a href="https://github.com/friendica/friendica/tree/develop/view/theme/frio2/README.md">ReadMe</a>.  Branched from Frio 0.8.5.
 * Version: V.0.1
...
function frio2_init(App $a)
{
	global $frio2;
	$frio2 = 'view/theme/frio2';
...
function frio2_install()
{
	Hook::register('prepare_body_final', 'view/theme/frio2/theme.php', 'frio2_item_photo_links');
	Hook::register('item_photo_menu', 'view/theme/frio2/theme.php', 'frio2_item_photo_menu');
	Hook::register('contact_photo_menu', 'view/theme/frio2/theme.php', 'frio2_contact_photo_menu');
	Hook::register('nav_info', 'view/theme/frio2/theme.php', 'frio2_remote_nav');
	Hook::register('acl_lookup_end', 'view/theme/frio2/theme.php', 'frio2_acl_lookup');
	Hook::register('display_item', 'view/theme/frio2/theme.php', 'frio2_display_item');

	Logger::log('installed theme frio2');
}

function frio2_uninstall()
{
	Hook::unregister('prepare_body_final', 'view/theme/frio2/theme.php', 'frio2_item_photo_links');
	Hook::unregister('item_photo_menu', 'view/theme/frio2/theme.php', 'frio2_item_photo_menu');
	Hook::unregister('contact_photo_menu', 'view/theme/frio2/theme.php', 'frio2_contact_photo_menu');
	Hook::unregister('nav_info', 'view/theme/frio2/theme.php', 'frio2_remote_nav');
	Hook::unregister('acl_lookup_end', 'view/theme/frio2/theme.php', 'frio2_acl_lookup');
	Hook::unregister('display_item', 'view/theme/frio2/theme.php', 'frio2_display_item');

	Logger::log('uninstalled theme frio2');
}
 ...
 */
function frio2_item_photo_links(App $a, &$body_info)
{
	$occurence = 0;
 ...
 */
function frio2_item_photo_menu(App $a, &$arr)
{
 ...
 */
function frio2_contact_photo_menu(App $a, &$args)
{
	$cid = $args['contact']['id'];
 ...
 */
function frio2_remote_nav($a, &$nav)
{
 ...
 */
function frio2_acl_lookup(App $a, &$results)
{
 ...
 */
function frio2_display_item(App $a, &$arr)
{
