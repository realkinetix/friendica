<?php
/**
 * @file view/theme/frio2/php/modes/default.php
...
require_once 'view/theme/frio2/php/frio2_boot.php';
...
<html>
	<head>
		...
		<script type="text/javascript">var frio2 = "<?php echo 'view/theme/frio2'; ?>";</script>
<?php
		...
		// It makes mobile Chrome UI match Frio2's top bar color.
...
<?php
				if ((empty($_REQUEST['pagename']) || $_REQUEST['pagename'] != "lostpass") && ($_SERVER['REQUEST_URI'] != $basepath)) {
					...
					<div class="col-lg-7 col-md-7 col-sm-12 col-12" id="content">
					...
					echo '
					<div class="col-lg-12 col-md-12 col-sm-12 col-12" id="content" style="margin-top:50px;">';
						if (!empty($page['content'])) {
							echo $page['content'];
						}
						echo '
