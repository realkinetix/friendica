...
$("nav").bind('nav-update', function(e,data)
{
	...
	if (count>0)
	{
		...
		/* document.getElementById('notifsound').innerHTML='<object type="audio/mpeg" width="0" height="0" data="<?=$frio2?>/audios/901.mp3"><param name="notif" value="<?=$frio2?>/audios/901.mp3" /><param name="autostart" value="true" /><param name="loop" value="false" /></object>'; */
	}
	else
	{
...
<script src="<?=$frio2?>/frameworks/justifiedGallery/jquery.justifiedGallery.min.js"></script>
